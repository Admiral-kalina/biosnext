                ...
                translation: {
                    levels: {
                        ...
                        intermediate:{
                            ...
                            text3:'Motivation for development and career growth in the pharmaceutical or related industries',
                        },
                        advanced:{
                        ...
                        specialized :{
                            ...
                            text3:'Motivation for the development and application of trend and innovative areas of pharmacovigilance',
                        },
                    },
                    servicesTopics: {
                        ...
                        title: 'UNIVERSAL SCHOOL OF PHARMACOVIGILANCE & MEDICAL AFFAIRS provides its partners with comprehensive services the receipt of which have a number of significant advantages:',
                        topic1: {
                            title: 'Audits (pharmacovigilance systems, registration dossier)',
                            text1: 'a. Ensure compliance with regulations and requirements, reducing the risk of violations and fines',
                        ...
                        topic4: {
                            ...
                            text6: 'f. Certification confirming knowledge and skills in the field of pharmacovigilance, GMP certification, registration and clinical development in the pharmaceutical industry',
                        },
                    },
                    ...
                    home: {
                        ...
                        coach: {
                            ...
                            text2: 'Our main goal is to provide the needs of the market with the best specialists in their field. We do this by teaching professionals innovative concepts that they can only get from practicing experts.'
                        }
                    },
                    aboutCompany: {
                        hero: {
                ...
                translation: {
                    levels: {
                        ...
                        intermediate:{
                            ...
                            text3:'Мотивация к развитию и карьерному росту в фармацевтической или смежной отраслях',
                        },
                        advanced:{
                        ...
                        specialized :{
                            ...
                            text3:'Мотивация к освоению и применению трендовых и инновационных направлений фармаконадзора',
                        },
                    },
                    servicesTopics: {
                        farma: 'Фармаконадзор',
                        ...
                        title: 'Universal School of Pharmacovigilance & Medical affairs предоставляет своим партнерам комплексные услуги, получение которых имеет много значительных преимуществ:',
                        topic1: {
                            title: 'Аудиты (системы фармаконадзора, регистрационного досье)',
                            text1: 'a. Обеспечение соответствия нормативам и требованиям, уменьшая риск нарушений и штрафов',
                        ...
                        topic4: {
                            ...
                            text6: 'f. Сертификация, подтверждающая знания и навыки в сфере фармаконадзора, GMP-сертификации, регистрации и клинического развития в фармацевтической отрасли ',
                        },
                    },
...
// {t('additional.minutes')}
                    ...
                    individual: {
                        ...
                        text2: 'Заполните, пожалуйста, форму обратной связи и укажите желаемую тему вебинара или название программы, а мы подберем для Вас оптимальный состав специалистов и удобный формат.',
                    },
                    form: {
                        title: 'Ваш заказ',
                ...
                translation: {
                    levels: {
                        ...
                        intermediate:{
                            ...
                            text3:'Мотивація до розвитку та кар\'єрного зростання у фармацевтичній чи суміжній галузях',
                        },
                        advanced:{
                        ...
                        specialized :{
                            ...
                            text3:'Мотивація до освоєння та застосування трендових та інноваційних напрямків фармаконагляду',
                        },
                    },
                    servicesTopics: {
                        farma: 'Фармаконагляд',
                        ...
                        title: 'UNIVERSAL SCHOOL OF PHARMACOVIGILANCE & MEDICAL AFFAIRS надає своїм партнерам комплексні послуги, здобуття яких має багато значних переваг:',
                        topic1: {
                            title: 'Аудити (системи фармаконагляду, реєстраційного досьє)',
                            text1: 'a. Забезпечення відповідності нормативам та вимогам, зменшуючи ризик порушень та штрафів',
                        ...
                        topic4: {
                            ...
                            text6: 'f. Сертифікація, що підтверджує знання та навички у сфері фармаконагляду, GMP-сертифікації, реєстрації та клінічного розвитку у фармацевтичній галузі',
                        },
                    },
                    feedback: {
                    ...
                    home: {
                        ...
                        coach: {
                            ...
                            text2: 'Наша головна мета є забезпечення потреб ринку найкращими фахівцями у своїй галузі. Ми робимо це, навчаючи фахівців інноваційним концепціям, які вони можуть отримати тільки у практикуючих експертів.'
                        }
                    },
                    aboutCompany: {
                        hero: {
                    ...
                    individual: {
                        order: 'Замовити індвідуальне навчання',
                        ...
                        text2: 'Заповніть, будь ласка, форму зворотного зв\'язку та вкажіть бажану тему вебінару або назву програми, а ми підберемо для Вас оптимальний склад фахівців і зручний формат.',
                    },
                    form: {
                    ...
                    main: {
                        ...
                        box1: {
                            text1: 'Актуальные и компетентные материалы',
                            subtext1: 'Мы обеспечиваем доступ к самым современным знаниям и практическим инструментам',
                            text2: ' Экспертные преподаватели и ведущие школы',
                            subtext2: 'Мы сотрудничаем с ведущими в своей сфере специалистами международного значения',
                            text3: 'Интерактивность и практика',
                            subtext3: 'Наше обучение включает в себя практические задания, дискуссии и интерактивные упражнения',
