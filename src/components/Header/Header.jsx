            ...
            <div className="container d-block-md">
                ...
                <nav className="header__nav">
                    <ul>
                        ...
                        <li><Link className={`text-uppercase ${endpoint === 'contacts' ? 'active' : ''}`} href={'/contacts'}>контакты</Link></li>
                    </ul>
                </nav>
                ...
                <div className={`header__mobile ${burgerState ? 'active' : ''}`}>
                    <ul className="nav-menu__mobile">
                        ...
                        <li onClick={handleMobileClick}><Link className={`text-uppercase ${endpoint === 'contacts' ? 'active' : ''}`} href={'/contacts'}>контакты</Link></li>
                        {/*<li>*/}
                        {/*    <a href="#" className="text-uppercase"*/}
                        {/*    ><i className="icon-basket"></i>*/}
                        {/*        корзина*/}
